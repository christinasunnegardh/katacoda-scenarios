...
- *volumes* is needed if we want to be able to change the frontend while the containers are running, as it persists data generated by and used by the container.
