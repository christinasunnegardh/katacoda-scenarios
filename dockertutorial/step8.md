...
*PS: Did you find the easter eggs?! If not, make sure you visited all the links when running the containers... If you are interested, the repo of the example application can be found at https://github.com/klaraesr/my-application.*
